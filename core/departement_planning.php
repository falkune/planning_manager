<?php
function getPlannings($url){
  // cette fonction parmet retourne le planning de tous les employés d'un departement specifique
  ...
  if($today['weekday'] !== "Monday"){
    ...
    $employes = getAllUsersOfDepartement($url[1]);
