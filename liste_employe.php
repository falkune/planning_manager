<?php
  ...
  if(isset($_SESSION['admin'])){
    ...
    $list_employes = $request->fetchAll(PDO::FETCH_ASSOC);
...
<body>
  ...
  <div id="container_body">
    <table>
      ...
      <tbody>
        <?php
          foreach($list_employes as $value){
            echo '<tr>';
              echo '<td>'.$value['nom_employe'].'</td>';
              echo '<td>'.$value['premom_employe'].'</td>';
              echo '<td>'.$value['email_employe'].'</td>';
              echo '<td> <a href="edit_employe.php?emp='.$value['id_employe'].'" style="color:black; text-decoration: none;"><i class="fas fa-edit"></i> Modifier</a> <a href="delete_employe.php?emp='.$value['id_employe'].'" style="color:black; text-decoration: none;"><i class="fas fa-trash-alt"></i> Suprimer</a></td>';
            echo '</tr>';
          }
        ?>
      </tbody>
