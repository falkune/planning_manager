  ...
  <body>
    <header>
      ...
      <div id="navigation">
        <ul>
          ...
          <li id="new_dep">
            <i class="fas fa-plus"> Département</i>
          </li>
          <li id="new_shop">
    ...
    <main>
      <section id="main_section">
              ...
              <div class="modal-body">
                <p>
                  <form id="shop_form">
                    ...
                    <div>
                      <select name="dep_shop" id="dep_shop">
                        <option value="Aucun">departement</option>
                        <?php
                          foreach($departements as $value){
                            echo '<option value="'.$value['id_departement'].'">'.$value['nom_departement'].'</option>';
        ...
        <!-- modal de creation d'un nouveau departement -->
        <div class="modal" id="dep_modal" style="visibility: hidden;">
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <h3 class="modal-title">Nouveau Departement</h3>
                <button type="button" class="btn btn-secondary" data-dismiss="modal" style="float: right; color: red; font-size: large;" id="close_dep_modal"><i class="fas fa-times"></i></button>
              </div>
              <br>
              <div class="modal-body">
                <p>
                  <form id="dep_form">
                    <div>
                      <input type="text" name="name" placeholder="taper le nom du departement" id="depname" required/>
                    </div>
                    <div id="vdp">
                      <input type="submit" class="submitdepname" value="enregistrer" required/>
                    </div>
              ...
              <div id="dep_ok_error"> <!--  --> </div>
              <div id="dep_failed_error"> <!--  --> </div>
            </div>
          </div>
        </div>
                ...
                <p>
                  <form id="user_form">
                    ...
                    <div>
                      ...
                      <select name="edit_user_departement" id="user_dep">
                        <option value="Aucun">choix departement</option>
                        <?php
                          foreach($departements as $value){
                            echo '<option value="'.$value['id_departement'].'">'.$value['nom_departement'].'</option>';
                          }
        ...
        <div class="modal" id="planning_modal" style="visibility: hidden;">
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-header">
              ...
              <div class="modal-body">
                <p>
                  <form id="planning_form" method="get">
                    ...
                    <div>
                      <select name="dep_id" id="planning_dep_id" class="planning_select">
                        <option value="aucun">choix departement</option>
                        <?php
                          foreach($departements as $value){
                            echo '<option value="'.$value['id_departement'].'">'.$value['nom_departement'].'</option>';
              ...
              <div class="modal-body">
                <p>
                  <form id="edit_planning_form">
                    ...
                    <div>
                      <select id="planning_edit_id" class="planning_select">
                        <option value="aucun">choix departement</option>
                        <?php
                          foreach($departements as $value){
                            echo '<option value="'.$value['id_departement'].'">'.$value['nom_departement'].'</option>';
